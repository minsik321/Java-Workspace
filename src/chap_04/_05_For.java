...
public class _05_For {
    public static void main(String[] args) {
        ...
        System.out.println("어서오세요. 나코입니다.");
        // 만약에 인사 법이 바뀌면?
        System.out.println("환영합니다. 나코입니다.");   // Alt + l 을 누른 후 동시 드래그 해서 수정 가능
        ...
        // 짝수만 출력   (fori 만 적고 엔터시 for (int i = 0; i < ; i++) { 까지 자동으로 나타냄)
        // 0,2,4,6,8
        for (int i = 0; i < 10; i += 2) {     // (i = i + 2) = (i += 2)
            System.out.print(i);            // println 에서 ln을 제거하면 줄 바꿈을 하지 않고 출력함
        }
        System.out.println();
